        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('admin.coupon.update', $coupon->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        <label>Minimum Perchase Price</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="discount_type" class="form-control" id="">
                            <option @selected(old('discount_type', $coupon->discount_type) == 'percent') value="percent">Percent</option>
                            <option @selected(old('discount_type', $coupon->discount_type) == 'amount') value="amount">Amount
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="">
                            <option @selected(old('status', $coupon->status) == 1) value="1">Active</option>
                            <option @selected(old('status', $coupon->status) == 0) value="0">Inactive</option>
                        </select>
                    </div>
