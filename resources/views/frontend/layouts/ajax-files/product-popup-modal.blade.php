                ...
                @foreach ($product->productSizes as $productSize)
                    <div class="form-check">
                        <input class="form-check-input" type="radio" data-price="{{ $productSize->price }}"
                            name="product_size" id="size-{{ $productSize->id }}" value="{{ $productSize->id }}">
        ...
        @if ($product->productOptions()->exists())
            <div class="details_extra_item">
                ...
                @foreach ($product->productOptions as $productOption)
                    <div class="form-check">
                        <input class="form-check-input" name="product_option[]"
                            data-price="{{ $productOption->price }}" type="checkbox" value="{{ $productOption->id }}"
