            ...
            @foreach ($dailyOffers as $dailyOffer)
                <div class="col-xl-4">
                    <div class="fp__offer_item_single">
                        <div class="img">
                            <img src="{{ $dailyOffer->product->thumb_image }}" alt="offer" class="img-fluid w-100">
                        </div>
                        <div class="text">
                            @if ($dailyOffer->product->offer_price > 0)
                                <span>
                                    {{ discountInPercent($dailyOffer->product->price, $dailyOffer->product->offer_price) }}%off
                                </span>
                            @endif
                            ...
                            <ul class="d-flex flex-wrap">
                                <li>
                                    <a href="javascript:;" onclick="loadProductModal('{{ $dailyOffer->product->id }}')">
