<div class="tab-pane fade" id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-address-tab">
    <div class="fp_dashboard_body address_body">
        ...
        {{-- Show Addresses user currentry have --}}
            ...
            <div class="fp_dashboard_new_address ">
                <form action="{{ route('address.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="fp__check_single_form">
                                <textarea cols="3" rows="4" placeholder="Address" name="address">{{ old('address') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="fp__check_single_form check_area">
                                <div class="form-check">
                                    <input @checked(old('type') === 'home') class="form-check-input" type="radio"
                                ...
                                <div class="form-check">
                                    <input @checked(old('type') === 'office') class="form-check-input" type="radio"
            ...
            <div class="fp_dashboard_edit_address edit_section_{{ $address->id }}">
                <form action="{{ route('address.update', $address->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="fp__check_single_form">
                                <textarea cols="3" rows="4" placeholder="Address" name="address">{{ old('address', $address->address) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="fp__check_single_form check_area">
                                <div class="form-check">
                                    <input @checked(old('type', $address->type) === 'home') class="form-check-input" type="radio"
                                        name="type" id="flexRadioDefault1" value="home">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        home
                                    </label>
                                ...
                                <div class="form-check">
                                    <input @checked(old('type', $address->type) === 'office') class="form-check-input" type="radio"
                                        name="type" id="flexRadioDefault2" value="office">
                                    <label class="form-check-label" for="flexRadioDefault2">
                                        office
                                    </label>
